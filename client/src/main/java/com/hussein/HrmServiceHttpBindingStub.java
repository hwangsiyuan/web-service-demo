...
public class HrmServiceHttpBindingStub extends org.apache.axis.client.Stub implements com.hussein.HrmServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(com.hussein.JobTitleBean[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://localhost/services/HrmService", "out"));
        ...
        oper.setReturnClass(com.hussein.SubCompanyBean[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://localhost/services/HrmService", "out"));
        param = oper.getReturnParamDesc();
        ...
        oper.setReturnClass(com.hussein.UserBean[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://localhost/services/HrmService", "out"));
        param = oper.getReturnParamDesc();
    ...
    public HrmServiceHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cachedSerQNames.add(qName);
            cls = com.hussein.JobTitleBean[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.hussein.SubCompanyBean[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = com.hussein.UserBean[].class;
            cachedSerClasses.add(cls);
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0, in1});
  ...
  throw axisFaultException;
    ...
    public com.hussein.JobTitleBean[] getHrmJobTitleInfo(String in0, String in1, String in2) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0, in1, in2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.hussein.JobTitleBean[]) _resp;
            } catch (Exception _exception) {
                return (com.hussein.JobTitleBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.hussein.JobTitleBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public com.hussein.SubCompanyBean[] getHrmSubcompanyInfo(String in0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.hussein.SubCompanyBean[]) _resp;
            } catch (Exception _exception) {
                return (com.hussein.SubCompanyBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.hussein.SubCompanyBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public String getOneUserInfo(String in0) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0, in1});
  ...
  throw axisFaultException;
    ...
    public com.hussein.UserBean[] getHrmUserInfo(String in0, String in1, String in2, String in3, String in4, String in5) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0, in1, in2, in3, in4, in5});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.hussein.UserBean[]) _resp;
            } catch (Exception _exception) {
                return (com.hussein.UserBean[]) org.apache.axis.utils.JavaUtils.convert(_resp, com.hussein.UserBean[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
