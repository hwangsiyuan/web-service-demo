...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements WorkflowService {
    ...
    private String WorkflowServiceHttpPort_address = "http://oa.medbanks-test.cn//services/WorkflowService";
    ...
    public com.hussein.WorkflowServicePortType getWorkflowServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.hussein.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hussein.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
