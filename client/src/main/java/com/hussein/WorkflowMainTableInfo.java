...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.hussein.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           com.hussein.WorkflowRequestTableRecord[] requestRecords,
           String tableDBName) {
     ...
     */
    public com.hussein.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.hussein.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
